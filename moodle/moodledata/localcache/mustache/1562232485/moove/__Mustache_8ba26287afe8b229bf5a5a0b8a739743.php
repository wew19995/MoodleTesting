...
class __Mustache_8ba26287afe8b229bf5a5a0b8a739743 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block2fea7652cd6e85d4f40452af722bae13'),
            ));
...
';
    ...
    public function block2fea7652cd6e85d4f40452af722bae13($context)
    {
        $indent = $buffer = '';
