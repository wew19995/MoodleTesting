...
class __Mustache_8014f9b215aa36abe32b72548a37a852 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4f537661e6e6807fcdd71e03026e3761($context, $indent, $value);
        // 'list' section
        $value = $context->find('list');
        $buffer .= $this->section3d65659362a0c78c363719610faa9280($context, $indent, $value);
        // 'summary' section
        $value = $context->find('summary');
        $buffer .= $this->section221d2ed333b1fa2690881dc1073cd7dd($context, $indent, $value);
        $buffer .= $indent . '</div>
';
    ...
    private function section4f537661e6e6807fcdd71e03026e3761(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3d65659362a0c78c363719610faa9280(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section221d2ed333b1fa2690881dc1073cd7dd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
