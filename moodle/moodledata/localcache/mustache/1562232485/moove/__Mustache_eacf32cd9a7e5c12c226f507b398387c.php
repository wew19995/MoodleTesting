...
class __Mustache_eacf32cd9a7e5c12c226f507b398387c extends Mustache_Template
{
...
';
        $buffer .= $indent . '          <!-- small box -->
';
        $buffer .= $indent . '          <div class="small-box bg-5">
';
        $buffer .= $indent . '            <div class="inner">
';
        $buffer .= $indent . '              <h3>';
        $value = $this->resolveValue($context->find('financedptusers'), $context);
        $buffer .= $value;
        $buffer .= '</h3>
';
        $buffer .= $indent . '              <p>Finance Department</p>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="icon">
';
        $buffer .= $indent . '              <i class="slicon-user"></i>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '          </div>
...
';
        $buffer .= $indent . '              <h3>';
        $value = $this->resolveValue($context->find('accountdptusers'), $context);
        $buffer .= $value;
        $buffer .= '</h3>
';
        $buffer .= $indent . '              <p>Accounting Department</p>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="icon">
...
';
        $buffer .= $indent . '              <h3>';
        $value = $this->resolveValue($context->find('securitiesdptusers'), $context);
        $buffer .= $value;
        $buffer .= '</h3>
';
        $buffer .= $indent . '              <p>Securities Department</p>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="icon">
...
';
        $buffer .= $indent . '              <h3>';
        $value = $this->resolveValue($context->find('insurancedptusers'), $context);
        $buffer .= $value;
        $buffer .= '</h3>
';
        $buffer .= $indent . '              <p>Insurance Department</p>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            <div class="icon">
