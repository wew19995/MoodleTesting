...
if (is_siteadmin()) {
    ...
    $financedptusers = $DB->count_records('user', array('department' => 'Finance'));
    $accountdptusers = $DB->count_records('user', array('department' => 'Accounting'));
    $securitiesdptusers = $DB->count_records('user', array('department' => 'Securities'));
    $insurancedptusers = $DB->count_records('user', array('department' => 'Insurance'));
    $totalactiveusers = $DB->count_records('user', array('deleted' => 0, 'suspended' => 0)) - 2;
    ...
    $templatecontext['financedptusers'] = $financedptusers;
    $templatecontext['accountdptusers'] = $accountdptusers;
    $templatecontext['securitiesdptusers'] = $securitiesdptusers;
    $templatecontext['insurancedptusers'] = $insurancedptusers;
